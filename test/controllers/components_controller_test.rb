...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { command: @component.command, dependent_id: @component.dependent_id, had_dependency: @component.had_dependency, name: @component.name } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { command: @component.command, dependent_id: @component.dependent_id, had_dependency: @component.had_dependency, name: @component.name } }
